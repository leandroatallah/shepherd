...
func GetPhases() []phases.Phase {
	return []phases.Phase{
		...
		},
		{
			...
			NextPhaseID:  9,
			SequencePath: "assets/sequences/phase-1-2.json",
			GoalType:     gamescenephases.ReactEndpointType,
			SceneType:    scenestypes.ScenePhases,
		},
		{
			...
			NextPhaseID:  10,
			SequencePath: "assets/sequences/phase-1-3.json",
			GoalType:     gamescenephases.ReactEndpointType,
			SceneType:    scenestypes.ScenePhases,
		},
		{
			ID:           10,
			Name:         "Area 1 - Stage 4",
			TilemapPath:  "assets/tilemap/shepherd-phase-1-4.tmj",
			NextPhaseID:  1,
			SequencePath: "assets/sequences/phase-1-4.json",
			GoalType:     gamescenephases.ReactEndpointType,
			SceneType:    scenestypes.ScenePhases,
		},
	}
