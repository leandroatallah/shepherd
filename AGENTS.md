...
*   **Reusable Mocks**: If a mock is used in more than one test file across different packages, place it in `internal/engine/internal/mocks`. This prevents code duplication.
